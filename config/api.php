...
class ApiClient
{
    ...
    /**
     * Executa múltiplas requisições GET em paralelo para melhorar a performance.
     * @param array $requests Associative array ['key' => '/path?query']
     */
